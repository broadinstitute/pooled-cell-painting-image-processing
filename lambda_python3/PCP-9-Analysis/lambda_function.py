...
def lambda_handler(event, context):
    ...
    for eachplate in platelist:
        ...
        bucket_folder = '/home/ubuntu/bucket/'+image_prefix+batch+'/images_corrected_cropped'
        per_plate_csv = create_CSVs.create_CSV_pipeline9(eachplate, num_sites, expected_cycles, bucket_folder, well_list)
        csv_on_bucket_name = prefix + 'load_data_csv/'+batch+'/'+eachplate+'/load_data_pipeline9.csv'
    ...
    #make the jobs
    create_batch_jobs.create_batch_jobs_9(image_prefix,batch,pipeline_name,plate_and_well_list, range(num_series), app_name)
