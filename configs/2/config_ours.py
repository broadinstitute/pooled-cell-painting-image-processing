...
APP_NAME = '2018_11_20_Periscope_X_ApplyIllumPainting'                # Used to generate derivative names unique to the application.
...
EXPECTED_NUMBER_FILES = 5000    # What is the number of files that trigger skipping a job?
