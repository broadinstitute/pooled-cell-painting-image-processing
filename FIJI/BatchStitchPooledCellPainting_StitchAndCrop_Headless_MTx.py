...
if os.path.isdir(subdir):
        ...
        if round_or_square == 'square':
                ...
                for eachwell in welllist:
                        standard_grid_instructions=["type=["+stitchorder+"] order=[Left & Up] grid_size_x="+rows+" grid_size_y="+columns+" tile_overlap="+overlap_pct+" first_file_index_i=0 directory="+subdir+" file_names=",
